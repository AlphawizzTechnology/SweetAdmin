                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Banner</h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Slider Title: *</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Slider Url</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="emp_fullname" class="form-control" placeholder="Slider Url/Link"  value="<?php echo $slider->slider_url;?>"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Select Status : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Sub Category : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="saveslider" value="Add Slider" class="btn btn-fill btn-rose" >                                                </div>
                                            </div>
                                        </div>
                                </div>
                            </div>
