                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_products"); ?>">ADD</a>
                                    <a class="pull-right" href="<?php echo site_url("csv"); ?>" style="margin:  0px 10px;padding: 0px 10px;border: 1px solid;" >BULK UPLOAD</a>
...
<td class="text-center"><?php echo $product->tax; ?></td>
...
<td class="text-center"><?php if($product->loca_category == 18) { echo "Kolkata"; } else { echo "Outside Kolkata"; } ?></td>
