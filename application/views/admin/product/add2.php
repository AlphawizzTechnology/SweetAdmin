                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Product</h4>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                            <label class="col-md-3 label-on-left">Thumbnail Image:</label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Pincode : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="pincode" pattern="[0-9]{6}" class="form-control" placeholder="00"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Weight : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
...
<div class="row">
                                            <label class="col-md-3 label-on-left">Product Location : *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                   <select name="product_location" class="form-control">
                                                       ...
                                                       <option value="9">Across All India</option>
