                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Society Name : </label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Pincode / Area code / Zip : </label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <button type="submit" class="btn btn-fill btn-rose" name="addcatg" value="Update Society">UPDATE</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
