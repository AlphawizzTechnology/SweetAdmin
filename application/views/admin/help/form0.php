                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="text-input form-control" name="mobile" max="9" placeholder="Your Moile No.">
                                        </div>
                                        <div class="form-group">
                                            <label class="">Email<span class="text-danger">*</span></label>
                                            <input type="number" class="text-input form-control" name="email" placeholder="Your Mail">
                                        </div>
                                        <div class="form-group">
                                            <label class="">Message<span class="text-danger">*</span></label>
                                            <taxtarea class="textarea" style="width: 100%; height: 146px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;  " name="msg" placeholder="Your Message" cols="10"></taxtarea>
                                        </div>
