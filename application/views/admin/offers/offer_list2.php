                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">All Offer List</h4>
                                    <a class="pull-right" href="<?php echo site_url("admin/add_offer"); ?>"> Add</a>
                                    <div class="toolbar">
                                            ...
                                            <tbody>
                                                <?php foreach($coupons as $coupon){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?= $coupon->offer_name; ?></td>
                                                        <td class="text-center"><?= $coupon->product_id;?></td>
                                                        <td class="text-center"><?= $coupon->user_id; ?></td>
                                                        <td class="text-center"><?= $coupon->from;?></td>
                                                        <td class="text-center"><?= $coupon->to; ?></td>
                                                        ...
                                                        <td class="td-actions text-right"><div class="">
                                                            <?php echo anchor('admin/editOffer/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/deleteOffer/'.$coupon->id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
