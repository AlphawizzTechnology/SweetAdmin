                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Purchase products</h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Page Title : *</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Page Description.</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <textarea id="editor1" name="page_descri" rows="10" cols="80" placeholder="Place some text here"><?php echo $onepage->pg_descri; ?></textarea>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" class="btn btn-fill btn-rose" name="savepageapp" value="Save Page">
                                                </div>
                                            </div>
                                        </div>
                                </div>
