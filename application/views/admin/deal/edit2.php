                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" id="id" name="prod_title" value="<?= $product->product_name;?>" placeholder="Product Title" class="form-control"/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="addcatg" value="Edit Product"  class="btn btn-fill btn-rose" />
                                                </div>
                                            </div>
                                        </div>
                                </div>
