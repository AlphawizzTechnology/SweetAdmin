                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Add Products</h4>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" id="id" name="prod_title" placeholder="Product Title" class="form-control"/>
                                                    <div class="well" id="result" style="display:none;"></div>  
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Deal Price: *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Start From: *</label>
                                            <div class="col-md-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="start_date" id='txtDate' class="form-control datetimepicker" readonly="">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">End To: *</label>
                                            <div class="col-md-4">
                                                <div class="card">
                                                    <div class="card-header card-header-icon" data-background-color="rose">
                                                        <i class="material-icons">today</i>
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="label-control"></label>
                                                            <input type='text' id='txtDate2' name="end_date" class="form-control datetimepicker" placeholder="00" readonly="">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                </div>
                                            </div>
