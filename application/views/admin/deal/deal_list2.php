                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_dealproduct"); ?>">ADD</a>
                                            ...
                                            <tbody>
                                                <?php foreach($deal_products as $product){ ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td class="text-center"><?php if(strtotime($date1) <= strtotime($present) && strtotime($present) <=strtotime($date2)){ echo 'Running'; }
                                                            else if(strtotime($date1) > strtotime($present)){echo "Is going to";}
                                                            else{echo 'Expired';} ?></th>
                                                        </td>
