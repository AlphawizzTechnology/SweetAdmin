                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <h4 class="card-title">Start Hour</h4>
                                            <div class="form-group">
                                                <label class="label-control"></label>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <h4 class="card-title">End Hour</h4>
                                            <div class="form-group">
                                                <label class="label-control"></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-button text-center">
                                            <input type="submit" name="addcatg" value="Add"  class="btn btn-fill btn-rose" />
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Closing Date</h4>
                                    <div class="toolbar">
