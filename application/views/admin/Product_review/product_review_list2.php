                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <!-- <a class="pull-right" href="<?php echo site_url("admin/add_coupons"); ?>"> Add</a> -->
                                    <div class="toolbar">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                            <?php $this->id=0; ?>
                                                <?php foreach($reviews as $r){ $this->id++; ?>
                                                    <tr>
                                                        <td class="text-center"><?= $this->id; ?></td>
                                                        <td class="text-center"><?= $r->product_name; ?></td>
                                                        <td class="text-center"><?= $r->total; ?></td>
                                                        <td class="text-center"><a href="<?= base_url() ?>admin/Review_list/<?= $r->product_id?>">See Comments</a></td>
