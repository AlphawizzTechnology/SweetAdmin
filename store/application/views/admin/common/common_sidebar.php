        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo site_url("admin/registers"); ?>">
                <i class="fa fa-mobile"></i> <span> <?php echo "App Users";?></span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
           <!--  <li>
         ...
         <!--     <li>
            ...
            <li>
              <a href="<?php echo site_url("admin/add_purchase"); ?>">
                <i class="fa fa-shopping-cart"></i> <span> <?php echo "Stock Update";?></span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
            <li>
         ...
         <!--    <li>
           ...
           <!--  <li>
             ...
             <li>
              <a href="#">
                <i class="fa fa-users"></i> <span> <?php echo "Add Delivery Boy";?></span> 
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu"> 
                        <li><a href="<?php echo site_url("users"); ?>"><i class="fa fa-circle-o"></i>
                         <?php echo "Add Delivery Boy";?></a></li>
